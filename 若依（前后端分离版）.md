...
http://localhost/dev-api/captchaImage 前端 Vue 获取图片，前端还是后端？
...
AsyncManager.me().execute(AsyncFactory.recordLog ininfor(username, Constants.LOGIN_FAIL, MessageUtils.message("user.password.not.match")));
